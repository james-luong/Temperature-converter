...
class Convertor:
    def __init__(self):
        ...
        # Export button (row 1)
        self.help_button = Button(self.converter_frame, text='Export',
    ...
    def help_activate(self):
        ...
        get_help = Help(self)
        get_help.help_text.configure(text='Enter a number in the box '
                                          'and then push one of the buttons'
                                          'to convert to either '
                                          'degrees Celsius (deg C) or '
